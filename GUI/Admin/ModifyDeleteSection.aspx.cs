...
{
	/// <summary>
	/// Code behind file for the ModifyDeleteSection form.
	/// </summary>
	public partial class ModifyDeleteSection : System.Web.UI.Page
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!Page.IsPostBack)
			{
				// bind the sections repeater to a dataview with all sections and the amount of forums inside that section.
				DataView sections = SectionGuiHelper.GetAllSectionsWStatisticsAsDataView(false);
		...
		{    
			this.rpSections.ItemCommand += new System.Web.UI.WebControls.RepeaterCommandEventHandler(this.rpSections_ItemCommand);
		...
		/// to take.
		/// </param>
		private void rpSections_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
		{
			...
			switch(e.CommandName)
			{
				case "Modify":
					...
					Response.Redirect("ModifySection.aspx?SectionID=" + e.CommandArgument);
					break;
				case "Delete":
					// user pressed a delete button.
					Response.Redirect("DeleteSection.aspx?SectionID=" + e.CommandArgument);
					break;
			}
		}
	}
