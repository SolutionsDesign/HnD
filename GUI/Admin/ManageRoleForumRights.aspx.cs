...
{
	/// <summary>
	/// Code behind file for the ManageRoleForumRights form.
	/// </summary>
	public partial class ManageRoleForumRights : System.Web.UI.Page
	{
		...
		private void rpRoles_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
		{
			...
			{
				case "Manage":
					// user pressed a manage button. 
					Response.Redirect("ManageForumRights.aspx?RoleID=" + e.CommandArgument);
					break;
			}
		}
	}
