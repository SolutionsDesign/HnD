...
{
	/// <summary>
	/// Code behind file for the ModifyDeleteRole form.
	/// </summary>
	public partial class ModifyDeleteRole : System.Web.UI.Page
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!Page.IsPostBack)
			{
				...
				DataView roles = SecurityGuiHelper.GetAllRolesWithStatisticsAsDataView();
		...
		private void rpRoles_ItemCommand(object source, System.Web.UI.WebControls.RepeaterCommandEventArgs e)
		{
			...
			switch(e.CommandName)
			{
				case "Modify":
					...
					Response.Redirect("ModifyRole.aspx?RoleID=" + e.CommandArgument);
					break;
				case "Delete":
					// user pressed a delete button.
					Response.Redirect("DeleteRole.aspx?RoleID=" + e.CommandArgument);
					break;
			}
		}
	}
