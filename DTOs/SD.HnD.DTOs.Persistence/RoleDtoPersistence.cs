...
namespace SD.HnD.DTOs.Persistence
{
	...
	public static partial class RolePersistence
	{
		...
		/// <summary>Extension method which produces a projection to SD.HnD.DTOs.DtoClasses.RoleDto which instances are projected from the results of the specified baseQuery, which returns SD.HnD.DALAdapter.EntityClasses.RoleEntity instances, the root entity of the derived element returned by this query.</summary>
		...
		/// <summary>Extension method which produces a projection to SD.HnD.DTOs.DtoClasses.RoleDto which instances are projected from the results of the specified baseQuery using QuerySpec, which returns SD.HnD.DALAdapter.EntityClasses.RoleEntity instances, the root entity of the derived element returned by this query.</summary>
		/// <param name="baseQuery">The base query to project the derived element instances from.</param>
	...
	// __LLBLGENPRO_USER_CODE_REGION_END 
		...
		/// <summary>Extension method which produces a projection to SD.HnD.DTOs.DtoClasses.RoleDto which instances are projected from the SD.HnD.DALAdapter.EntityClasses.RoleEntity entity instance specified, the root entity of the derived element returned by this method.</summary>
