...
namespace SD.HnD.ReadOnlyElements.Persistence
{
	...
	public static partial class MessageInThreadPersistence
	{
		...
		/// <returns>DynamicQuery to retrieve SD.HnD.ReadOnlyElements.DtoClasses.MessageInThreadDto instances</returns>
		public static DynamicQuery<SD.HnD.ReadOnlyElements.DtoClasses.MessageInThreadDto> ProjectToMessageInThreadDto(this EntityQuery<SD.HnD.DALAdapter.EntityClasses.MessageEntity> baseQuery, SD.HnD.DALAdapter.FactoryClasses.QueryFactory qf)
		{
			return qf.Create()
				...
				.Select(() => new SD.HnD.ReadOnlyElements.DtoClasses.MessageInThreadDto()
				{
					Attachments = (List<SD.HnD.ReadOnlyElements.DtoClasses.MessageInThreadDtoTypes.AttachmentDto>)qf.Attachment.TargetAs("__L1_0")
						.CorrelatedOver(MessageFields.MessageID.Source("__BQ").Equal(AttachmentFields.MessageID.Source("__L1_0")))
						.Select(() => new SD.HnD.ReadOnlyElements.DtoClasses.MessageInThreadDtoTypes.AttachmentDto()
						{
