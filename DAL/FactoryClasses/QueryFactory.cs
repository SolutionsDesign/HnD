...
namespace SD.HnD.DAL.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		public DynamicQuery<SD.HnD.DAL.TypedListClasses.ForumMessagesRow> GetForumMessagesTypedList()
		{
			return this.Create()
						.Select(() => new SD.HnD.DAL.TypedListClasses.ForumMessagesRow()
								{
		...
		/// <returns>Dynamic Query which fetches <see cref="SD.HnD.DAL.TypedListClasses.ForumsWithSectionNameRow"/> instances </returns>
		public DynamicQuery<SD.HnD.DAL.TypedListClasses.ForumsWithSectionNameRow> GetForumsWithSectionNameTypedList()
		{
			return this.Create()
						.Select(() => new SD.HnD.DAL.TypedListClasses.ForumsWithSectionNameRow()
								{
		...
		public DynamicQuery<SD.HnD.DAL.TypedListClasses.MessagesInThreadRow> GetMessagesInThreadTypedList()
		{
			return this.Create()
		...
		/// <returns>Dynamic Query which fetches <see cref="SD.HnD.DAL.TypedListClasses.SearchResultRow"/> instances </returns>
		public DynamicQuery<SD.HnD.DAL.TypedListClasses.SearchResultRow> GetSearchResultTypedList()
		{
			return this.Create()
						.Select(() => new SD.HnD.DAL.TypedListClasses.SearchResultRow()
								{
