...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Attachment'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public AttachmentEntity(System.Int32 attachmentID, IPrefetchPath prefetchPathToUse):base("AttachmentEntity")
		{
