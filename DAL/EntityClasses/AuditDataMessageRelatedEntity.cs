...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AuditDataMessageRelated'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public AuditDataMessageRelatedEntity(System.Int32 auditDataID, IPrefetchPath prefetchPathToUse):base(auditDataID, prefetchPathToUse)
		{
		...
		public static new AuditDataMessageRelatedEntity FetchPolymorphic(ITransaction transactionToUse, System.Int32 auditDataID, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			fields.ForcedValueWrite((int)AuditDataMessageRelatedFieldIndex.AuditDataID, auditDataID);
