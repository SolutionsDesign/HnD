...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'SystemData'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public SystemDataEntity(System.Int32 iD, IPrefetchPath prefetchPathToUse):base("SystemDataEntity")
		{
