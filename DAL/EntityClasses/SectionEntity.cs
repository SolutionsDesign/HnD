...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Section'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public SectionEntity(System.Int32 sectionID, IPrefetchPath prefetchPathToUse):base("SectionEntity")
		{
