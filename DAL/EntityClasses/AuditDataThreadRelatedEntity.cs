...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AuditDataThreadRelated'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public AuditDataThreadRelatedEntity(System.Int32 auditDataID, IPrefetchPath prefetchPathToUse):base(auditDataID, prefetchPathToUse)
		{
		...
		public static new AuditDataThreadRelatedEntity FetchPolymorphic(ITransaction transactionToUse, System.Int32 auditDataID, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			fields.ForcedValueWrite((int)AuditDataThreadRelatedFieldIndex.AuditDataID, auditDataID);
