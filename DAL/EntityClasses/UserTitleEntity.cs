...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UserTitle'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public UserTitleEntity(System.Int32 userTitleID, IPrefetchPath prefetchPathToUse):base("UserTitleEntity")
		{
