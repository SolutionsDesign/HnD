...
namespace SD.HnD.DAL.TypedListClasses
{
	...
	/// <remarks>This class is a result class for a query, which is produced with the method <see cref="SD.HnD.DAL.FactoryClasses.QueryFactory.GetMessagesInThreadTypedList"/>.
