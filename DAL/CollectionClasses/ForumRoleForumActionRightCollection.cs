...
namespace SD.HnD.DAL.CollectionClasses
{
	...
	public partial class ForumRoleForumActionRightCollection : EntityCollectionBase<ForumRoleForumActionRightEntity>
	{
		...
		public ForumRoleForumActionRightCollection(IList<ForumRoleForumActionRightEntity> initialContents):base(new ForumRoleForumActionRightEntityFactory())
		{
		...
		{
			return GetMultiManyToOne(actionRightInstance, forumInstance, roleInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(actionRightInstance, forumInstance, roleInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		public virtual bool GetMultiManyToOne(IEntity actionRightInstance, IEntity forumInstance, IEntity roleInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, filter, actionRightInstance, forumInstance, roleInstance, pageNumber, pageSize);
		}
		...
		{
			ForumRoleForumActionRightDAO dao = DAOFactory.CreateForumRoleForumActionRightDAO();
			return dao.DeleteMulti(base.Transaction, actionRightInstance, forumInstance, roleInstance);
		}
		...
		{
			ForumRoleForumActionRightDAO dao = DAOFactory.CreateForumRoleForumActionRightDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, actionRightInstance, forumInstance, roleInstance);
		}
