...
namespace SD.HnD.DAL.CollectionClasses
{
	...
	public partial class SupportQueueThreadCollection : EntityCollectionBase<SupportQueueThreadEntity>
	{
		...
		public SupportQueueThreadCollection(IList<SupportQueueThreadEntity> initialContents):base(new SupportQueueThreadEntityFactory())
		{
		...
		{
			return GetMultiManyToOne(supportQueueInstance, claimedByUserInstance, placedInQueueByUserInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(supportQueueInstance, claimedByUserInstance, placedInQueueByUserInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		public virtual bool GetMultiManyToOne(IEntity supportQueueInstance, IEntity claimedByUserInstance, IEntity placedInQueueByUserInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, filter, supportQueueInstance, claimedByUserInstance, placedInQueueByUserInstance, pageNumber, pageSize);
		}
		...
		{
			SupportQueueThreadDAO dao = DAOFactory.CreateSupportQueueThreadDAO();
			return dao.DeleteMulti(base.Transaction, supportQueueInstance, claimedByUserInstance, placedInQueueByUserInstance);
		}
		...
		{
			SupportQueueThreadDAO dao = DAOFactory.CreateSupportQueueThreadDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, supportQueueInstance, claimedByUserInstance, placedInQueueByUserInstance);
		}
