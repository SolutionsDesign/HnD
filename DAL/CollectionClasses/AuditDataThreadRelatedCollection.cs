...
namespace SD.HnD.DAL.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of AuditDataThreadRelatedEntity objects. </summary>
	[Serializable]
	public partial class AuditDataThreadRelatedCollection : EntityCollectionBase<AuditDataThreadRelatedEntity>
	{
		/// <summary> CTor</summary>
		public AuditDataThreadRelatedCollection():base(new AuditDataThreadRelatedEntityFactory())
		{
		}
		...
		public AuditDataThreadRelatedCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected AuditDataThreadRelatedCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity auditActionInstance, IEntity threadInstance, IEntity userAuditedInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(auditActionInstance, threadInstance, userAuditedInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity auditActionInstance, IEntity threadInstance, IEntity userAuditedInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
		...
		/// <param name="entityWithNewValues">AuditDataThreadRelatedEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		/// <param name="auditActionInstance">AuditActionEntity instance to use as a filter for the AuditDataThreadRelatedEntity objects to return</param>
		/// <param name="threadInstance">ThreadEntity instance to use as a filter for the AuditDataThreadRelatedEntity objects to return</param>
		/// <param name="userAuditedInstance">UserEntity instance to use as a filter for the AuditDataThreadRelatedEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		/// <summary> Deletes from the persistent storage all AuditDataThreadRelated entities which match with the specified filter, formulated in the predicate or predicate expression definition.</summary>
		/// <param name="deleteFilter">A predicate or predicate expression which should be used as filter for the entities to delete. Can be null, which will result in a query removing all AuditDataThreadRelated entities from the persistent storage</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		public object GetScalar(AuditDataThreadRelatedFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AuditDataThreadRelatedFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AuditDataThreadRelatedFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AuditDataThreadRelatedFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(AuditDataThreadRelatedFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
