...
namespace SD.HnD.DAL.CollectionClasses
{
	...
	public partial class AuditDataMessageRelatedCollection : EntityCollectionBase<AuditDataMessageRelatedEntity>
	{
		...
		public AuditDataMessageRelatedCollection(IList<AuditDataMessageRelatedEntity> initialContents):base(new AuditDataMessageRelatedEntityFactory())
		{
		...
		{
			return GetMultiManyToOne(auditActionInstance, messageInstance, userAuditedInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, null, 0, 0);
		}
		...
		{
			return GetMultiManyToOne(auditActionInstance, messageInstance, userAuditedInstance, base.MaxNumberOfItemsToReturn, base.SortClauses, filter, 0, 0);
		}
		...
		public virtual bool GetMultiManyToOne(IEntity auditActionInstance, IEntity messageInstance, IEntity userAuditedInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return dao.GetMulti(base.Transaction, this, maxNumberOfItemsToReturn, sortClauses, base.EntityFactoryToUse, filter, auditActionInstance, messageInstance, userAuditedInstance, pageNumber, pageSize);
		}
		...
		{
			AuditDataMessageRelatedDAO dao = DAOFactory.CreateAuditDataMessageRelatedDAO();
			return dao.DeleteMulti(base.Transaction, auditActionInstance, messageInstance, userAuditedInstance);
		}
		...
		{
			AuditDataMessageRelatedDAO dao = DAOFactory.CreateAuditDataMessageRelatedDAO();
			return dao.UpdateMulti(entityWithNewValues, base.Transaction, auditActionInstance, messageInstance, userAuditedInstance);
		}
