...
namespace SD.HnD.DAL.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of AuditActionEntity objects. </summary>
	[Serializable]
	public partial class AuditActionCollection : EntityCollectionBase<AuditActionEntity>
	{
		/// <summary> CTor</summary>
		public AuditActionCollection():base(new AuditActionEntityFactory())
		{
		}
		...
		public AuditActionCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected AuditActionCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		/// <returns>true if the retrieval succeeded, false otherwise</returns>
		public bool GetMultiManyToManyUsingRolesWithAuditAction(IEntity roleInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses)
		{
		...
		public object GetScalar(AuditActionFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AuditActionFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AuditActionFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(AuditActionFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(AuditActionFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
