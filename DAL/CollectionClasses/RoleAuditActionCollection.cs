...
namespace SD.HnD.DAL.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of RoleAuditActionEntity objects. </summary>
	[Serializable]
	public partial class RoleAuditActionCollection : EntityCollectionBase<RoleAuditActionEntity>
	{
		/// <summary> CTor</summary>
		public RoleAuditActionCollection():base(new RoleAuditActionEntityFactory())
		{
		}
		...
		public RoleAuditActionCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected RoleAuditActionCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity auditActionInstance, IEntity roleInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(auditActionInstance, roleInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity auditActionInstance, IEntity roleInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
		...
		/// <param name="entityWithNewValues">RoleAuditActionEntity instance which holds the new values for the matching entities to update. Only changed fields are taken into account</param>
		/// <param name="auditActionInstance">AuditActionEntity instance to use as a filter for the RoleAuditActionEntity objects to return</param>
		/// <param name="roleInstance">RoleEntity instance to use as a filter for the RoleAuditActionEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		public object GetScalar(RoleAuditActionFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(RoleAuditActionFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(RoleAuditActionFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(RoleAuditActionFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(RoleAuditActionFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
