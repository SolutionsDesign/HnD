...
namespace SD.HnD.DAL.HelperClasses
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitForumEntityMappings()
		{
			...
			this.AddElementFieldMapping( "ForumEntity", "DefaultSupportQueueID", "DefaultSupportQueueID", true, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 6 );
			this.AddElementFieldMapping( "ForumEntity", "DefaultThreadListInterval", "DefaultThreadListInterval", false, "TinyInt", 0, 0, 3, false, "", null, typeof(System.Byte), 7 );
			this.AddElementFieldMapping( "ForumEntity", "OrderNo", "OrderNo", false, "SmallInt", 0, 0, 5, false, "", null, typeof(System.Int16), 8 );
			this.AddElementFieldMapping( "ForumEntity", "MaxAttachmentSize", "MaxAttachmentSize", true, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 9 );
			this.AddElementFieldMapping( "ForumEntity", "MaxNoOfAttachmentsPerMessage", "MaxNoOfAttachmentsPerMessage", true, "SmallInt", 0, 0, 5, false, "", null, typeof(System.Int16), 10 );
		...
		private void InitIPBanEntityMappings()
		{
			...
			this.AddElementFieldMapping( "IPBanEntity", "IPSegment3", "IPSegment3", false, "TinyInt", 0, 0, 3, false, "", null, typeof(System.Byte), 3 );
			this.AddElementFieldMapping( "IPBanEntity", "IPSegment4", "IPSegment4", false, "TinyInt", 0, 0, 3, false, "", null, typeof(System.Byte), 4 );
			this.AddElementFieldMapping( "IPBanEntity", "Range", "Range", false, "TinyInt", 0, 0, 3, false, "", null, typeof(System.Byte), 5 );
			this.AddElementFieldMapping( "IPBanEntity", "IPBanSetByUserID", "IPBanSetByUserID", false, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 6 );
		...
		private void InitMessageEntityMappings()
		{
			...
			this.AddElementFieldMapping( "MessageEntity", "ThreadID", "ThreadID", false, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 3 );
		...
		private void InitSectionEntityMappings()
		{
			...
			this.AddElementFieldMapping( "SectionEntity", "OrderNo", "OrderNo", false, "SmallInt", 0, 0, 5, false, "", null, typeof(System.Int16), 3 );
		}
		...
		private void InitSupportQueueEntityMappings()
		{
			...
			this.AddElementFieldMapping( "SupportQueueEntity", "OrderNo", "OrderNo", false, "SmallInt", 0, 0, 5, false, "", null, typeof(System.Int16), 3 );
		}
		...
		private void InitSupportQueueThreadEntityMappings()
		{
			...
			this.AddElementFieldMapping( "SupportQueueThreadEntity", "ClaimedByUserID", "ClaimedByUserID", true, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 4 );
		...
		private void InitSystemDataEntityMappings()
		{
			...
			this.AddElementFieldMapping( "SystemDataEntity", "DefaultUserTitleNewUser", "DefaultUserTitleNewUser", false, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 3 );
			this.AddElementFieldMapping( "SystemDataEntity", "HoursThresholdForActiveThreads", "HoursThresholdForActiveThreads", false, "SmallInt", 0, 0, 5, false, "", null, typeof(System.Int16), 4 );
			this.AddElementFieldMapping( "SystemDataEntity", "PageSizeSearchResults", "PageSizeSearchResults", false, "SmallInt", 0, 0, 5, false, "", null, typeof(System.Int16), 5 );
			...
			this.AddElementFieldMapping( "SystemDataEntity", "MinNumberOfNonStickyVisibleThreads", "MinNumberOfNonStickyVisibleThreads", false, "SmallInt", 0, 0, 5, false, "", null, typeof(System.Int16), 7 );
		...
		private void InitThreadEntityMappings()
		{
			...
			this.AddElementFieldMapping( "ThreadEntity", "StartedByUserID", "StartedByUserID", false, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 3 );
			...
			this.AddElementFieldMapping( "ThreadEntity", "NumberOfViews", "NumberOfViews", true, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 8 );
		...
		private void InitUserEntityMappings()
		{
			...
			this.AddElementFieldMapping( "UserEntity", "UserTitleID", "UserTitleID", false, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 8 );
			...
			this.AddElementFieldMapping( "UserEntity", "AmountOfPostings", "AmountOfPostings", true, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 15 );
			...
			this.AddElementFieldMapping( "UserEntity", "DefaultNumberOfMessagesPerPage", "DefaultNumberOfMessagesPerPage", true, "SmallInt", 0, 0, 5, false, "", null, typeof(System.Int16), 19 );
		}
