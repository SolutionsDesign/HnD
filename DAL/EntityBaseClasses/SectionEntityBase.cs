...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class SectionEntityBase : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public SectionEntityBase(System.Int32 sectionID)
		{
		...
		public SectionEntityBase(System.Int32 sectionID, IPrefetchPath prefetchPathToUse)
		{
		...
		public SectionEntityBase(System.Int32 sectionID, IValidator validator)
		{
		...
		{
			switch((SectionFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return SectionEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Forums":
					toReturn.Add(SectionEntity.Relations.ForumEntityUsingSectionID);
					break;
		...
		public override void UnsetRelatedEntity(IEntity relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "Forums":
					base.PerformRelatedEntityRemoval(_forums, relatedEntity, signalRelatedEntityManyToOne);
					break;
		...
		{
			return Fetch(sectionID, prefetchPathToUse, contextToUse, null);
		}
		...
		public bool TestOriginalFieldValueForNull(SectionFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(SectionFieldIndex fieldIndex)
		{
		...
		{
 			if( ( !_alreadyFetchedForums || forceFetch || _alwaysFetchForums) && !base.IsSerializing && !base.IsDeserializing && !base.InDesignMode)
			{
				if(base.ParticipatesInTransaction)
				{
					if(!_forums.ParticipatesInTransaction)
					{
						base.Transaction.Add(_forums);
					}
				}
		...
		{
			SectionDAO dao = (SectionDAO)CreateDAOInstance();
		...
		{
			_forums.ActiveContext = base.ActiveContext;
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 sectionID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(sectionID, prefetchPathToUse, null, null);
		...
		{
			_forums = new SD.HnD.DAL.CollectionClasses.ForumCollection(new ForumEntityFactory());
			_forums.SetContainingEntityInfo(this, "Section");
			_alwaysFetchForums = false;
			_alreadyFetchedForums = false;
		...
		private bool Fetch(System.Int32 sectionID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)SectionFieldIndex.SectionID].ForcedCurrentValueWrite(sectionID);
		...
		public static IPrefetchPathElement PrefetchPathForums
		{
			get
			{
				return new PrefetchPathElement(new SD.HnD.DAL.CollectionClasses.ForumCollection(),
					(IEntityRelation)GetRelationsForField("Forums")[0], (int)SD.HnD.DAL.EntityType.SectionEntity, (int)SD.HnD.DAL.EntityType.ForumEntity, 0, null, null, null, "Forums", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		{
			get { return SectionEntity.CustomProperties;}
		}
		...
		{
			get { return SectionEntity.FieldsCustomProperties;}
		}

		/// <summary> The SectionID property of the Entity Section<br/><br/>
		/// </summary>
		...
		/// <summary> The SectionName property of the Entity Section<br/><br/>
		/// </summary>
		...
		/// <summary> The SectionDescription property of the Entity Section<br/><br/>
		/// </summary>
		...
		/// <summary> The OrderNo property of the Entity Section<br/><br/>
		/// </summary>
		...
		/// persistent storage. When set to false, the data is only fetched the first time Forums is accessed. You can always execute
		/// a forced fetch by calling GetMultiForums(true).</summary>
		[Browsable(false)]
