...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class ThreadSubscriptionEntityBase : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ThreadSubscriptionEntityBase()
		{
			InitClassEmpty(null);
		}
		...
		public ThreadSubscriptionEntityBase(System.Int32 userID, System.Int32 threadID)
		{
		...
		public ThreadSubscriptionEntityBase(System.Int32 userID, System.Int32 threadID, IPrefetchPath prefetchPathToUse)
		{
		...
		public ThreadSubscriptionEntityBase(System.Int32 userID, System.Int32 threadID, IValidator validator)
		{
		...
		{
			return ThreadSubscriptionEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Thread":
					toReturn.Add(ThreadSubscriptionEntity.Relations.ThreadEntityUsingThreadID);
					break;
				case "User":
					toReturn.Add(ThreadSubscriptionEntity.Relations.UserEntityUsingUserID);
					break;
		...
		{
			return Fetch(userID, threadID, prefetchPathToUse, contextToUse, null);
		}
		...
		public bool TestOriginalFieldValueForNull(ThreadSubscriptionFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ThreadSubscriptionFieldIndex fieldIndex)
		{
		...
		public virtual ThreadEntity GetSingleThread(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(ThreadSubscriptionEntity.Relations.ThreadEntityUsingThreadID);
		...
		public virtual UserEntity GetSingleUser(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(ThreadSubscriptionEntity.Relations.UserEntityUsingUserID);
		...
		{
			ThreadSubscriptionDAO dao = (ThreadSubscriptionDAO)CreateDAOInstance();
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(SD.HnD.DAL.EntityType.ThreadSubscriptionEntity);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 userID, System.Int32 threadID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(userID, threadID, prefetchPathToUse, null, null);
		...
		{
			base.PerformDesetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", ThreadSubscriptionEntity.Relations.ThreadEntityUsingThreadID, true, signalRelatedEntity, "ThreadSubscription", resetFKFields, new int[] { (int)ThreadSubscriptionFieldIndex.ThreadID } );		
			_thread = null;
		}
		...
		private void SetupSyncThread(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", ThreadSubscriptionEntity.Relations.ThreadEntityUsingThreadID, true, ref _alreadyFetchedThread, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", ThreadSubscriptionEntity.Relations.UserEntityUsingUserID, true, signalRelatedEntity, "ThreadSubscription", resetFKFields, new int[] { (int)ThreadSubscriptionFieldIndex.UserID } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", ThreadSubscriptionEntity.Relations.UserEntityUsingUserID, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 userID, System.Int32 threadID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)ThreadSubscriptionFieldIndex.UserID].ForcedCurrentValueWrite(userID);
				base.Fields[(int)ThreadSubscriptionFieldIndex.ThreadID].ForcedCurrentValueWrite(threadID);
		...
		public static IPrefetchPathElement PrefetchPathThread
		{
			get
			{
				return new PrefetchPathElement(new SD.HnD.DAL.CollectionClasses.ThreadCollection(),
					(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DAL.EntityType.ThreadSubscriptionEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathUser
		{
			get
			{
				return new PrefetchPathElement(new SD.HnD.DAL.CollectionClasses.UserCollection(),
					(IEntityRelation)GetRelationsForField("User")[0], (int)SD.HnD.DAL.EntityType.ThreadSubscriptionEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return "ThreadSubscriptionEntity";}
		}
		...
		{
			get { return ThreadSubscriptionEntity.CustomProperties;}
		}
		...
		{
			get { return ThreadSubscriptionEntity.FieldsCustomProperties;}
		}

		/// <summary> The UserID property of the Entity ThreadSubscription<br/><br/>
		/// </summary>
		...
		/// <summary> The ThreadID property of the Entity ThreadSubscription<br/><br/>
		/// </summary>
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_thread != null)
						{
							_thread.UnsetRelatedEntity(this, "ThreadSubscription");
						}
					}
					else
					{
						if(_thread!=value)
						{
							((IEntity)value).SetRelatedEntity(this, "ThreadSubscription");
						}
					}
				}
			}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_user != null)
						{
							_user.UnsetRelatedEntity(this, "ThreadSubscription");
						}
					}
					else
					{
