...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class IPBanEntityBase : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public IPBanEntityBase(System.Int32 iPBanID)
		{
		...
		public IPBanEntityBase(System.Int32 iPBanID, IPrefetchPath prefetchPathToUse)
		{
		...
		public IPBanEntityBase(System.Int32 iPBanID, IValidator validator)
		{
		...
		{
			return IPBanEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "SetByUser":
					toReturn.Add(IPBanEntity.Relations.UserEntityUsingIPBanSetByUserID);
					break;
		...
		{
			return Fetch(iPBanID, prefetchPathToUse, contextToUse, null);
		}
		...
		public bool TestOriginalFieldValueForNull(IPBanFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(IPBanFieldIndex fieldIndex)
		{
		...
		{
			if( ( !_alreadyFetchedSetByUser || forceFetch || _alwaysFetchSetByUser) && !base.IsSerializing && !base.IsDeserializing  && !base.InDesignMode)			
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(IPBanEntity.Relations.UserEntityUsingIPBanSetByUserID);
				...
				else
				{
					...
					{
						if(performLazyLoading || (!performLazyLoading && (_setByUser == null)))
						{
							this.SetByUser = newEntity;
						}
					}
		...
		{
			IPBanDAO dao = (IPBanDAO)CreateDAOInstance();
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_setByUser!=null)
			{
				_setByUser.ActiveContext = base.ActiveContext;
			}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(SD.HnD.DAL.EntityType.IPBanEntity);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		protected virtual void InitClassFetch(System.Int32 iPBanID, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			base.Validator = validator;
			InitClassMembers();
			base.Fields = CreateFields();
			bool wasSuccesful = Fetch(iPBanID, prefetchPathToUse, null, null);
		...
		{
			base.PerformDesetupSyncRelatedEntity( _setByUser, new PropertyChangedEventHandler( OnSetByUserPropertyChanged ), "SetByUser", IPBanEntity.Relations.UserEntityUsingIPBanSetByUserID, true, signalRelatedEntity, "IPBansSet", resetFKFields, new int[] { (int)IPBanFieldIndex.IPBanSetByUserID } );		
			_setByUser = null;
		}
		...
		private void SetupSyncSetByUser(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _setByUser, new PropertyChangedEventHandler( OnSetByUserPropertyChanged ), "SetByUser", IPBanEntity.Relations.UserEntityUsingIPBanSetByUserID, true, ref _alreadyFetchedSetByUser, new string[] { "SetByUserNickName" } );
			}
		}
		...
		private void OnSetByUserPropertyChanged( object sender, PropertyChangedEventArgs e )
		{
			...
			{
				case "NickName":
					base.OnPropertyChanged("SetByUserNickName");
					break;
				default:
					break;
			}
		...
		private bool Fetch(System.Int32 iPBanID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				...
				base.Fields[(int)IPBanFieldIndex.IPBanID].ForcedCurrentValueWrite(iPBanID);
		...
		public static IPrefetchPathElement PrefetchPathSetByUser
		{
			get
			{
				return new PrefetchPathElement(new SD.HnD.DAL.CollectionClasses.UserCollection(),
					(IEntityRelation)GetRelationsForField("SetByUser")[0], (int)SD.HnD.DAL.EntityType.IPBanEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, "SetByUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return IPBanEntity.CustomProperties;}
		}
		...
		{
			get { return IPBanEntity.FieldsCustomProperties;}
		}

		/// <summary> The IPBanID property of the Entity IPBan<br/><br/>
		/// </summary>
		...
		/// <summary> The IPSegment1 property of the Entity IPBan<br/><br/>
		/// </summary>
		...
		/// <summary> The IPSegment2 property of the Entity IPBan<br/><br/>
		/// </summary>
		...
		/// <summary> The IPSegment3 property of the Entity IPBan<br/><br/>
		/// </summary>
		...
		/// <summary> The IPSegment4 property of the Entity IPBan<br/><br/>
		/// </summary>
		...
		/// <summary> The Range property of the Entity IPBan<br/><br/>
		/// </summary>
		...
		/// <summary> The IPBanSetByUserID property of the Entity IPBan<br/><br/>
		/// </summary>
		...
		/// <summary> The IPBanSetOn property of the Entity IPBan<br/><br/>
		/// </summary>
		...
		/// <summary> The Reason property of the Entity IPBan<br/><br/>
		/// </summary>
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_setByUser != null)
						{
							_setByUser.UnsetRelatedEntity(this, "IPBansSet");
						}
					}
					else
					{
						if(_setByUser!=value)
						{
							((IEntity)value).SetRelatedEntity(this, "IPBansSet");
						}
					}
				}
			}
		...
		/// persistent storage. When set to false, the data is only fetched the first time SetByUser is accessed. You can always execute
		/// a forced fetch by calling GetSingleSetByUser(true).</summary>
		[Browsable(false)]
		...
		/// <summary> Gets the value of the related field this.SetByUser.NickName.</summary>
