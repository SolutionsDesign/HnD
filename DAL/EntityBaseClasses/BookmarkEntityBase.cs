...
namespace SD.HnD.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected BookmarkEntityBase() :base("BookmarkEntity")
		{
			InitClassEmpty(null);
		}
		...
		protected BookmarkEntityBase(System.Int32 threadID, System.Int32 userID):base("BookmarkEntity")
		{
		...
		protected BookmarkEntityBase(System.Int32 threadID, System.Int32 userID, IPrefetchPath prefetchPathToUse): base("BookmarkEntity")
		{
		...
		protected BookmarkEntityBase(System.Int32 threadID, System.Int32 userID, IValidator validator):base("BookmarkEntity")
		{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.HnD.DAL.RelationClasses.StaticBookmarkRelations.UserEntityUsingUserIDStatic, true, signalRelatedEntity, "Bookmarks", resetFKFields, new int[] { (int)BookmarkFieldIndex.UserID } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.HnD.DAL.RelationClasses.StaticBookmarkRelations.UserEntityUsingUserIDStatic, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
