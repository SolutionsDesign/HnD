...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public abstract partial class BookmarkEntityBase : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected BookmarkEntityBase() : base()
		{
			InitClassEmpty(null);
		}
		...
		protected BookmarkEntityBase(System.Int32 threadID, System.Int32 userID)
		{
		...
		protected BookmarkEntityBase(System.Int32 threadID, System.Int32 userID, IPrefetchPath prefetchPathToUse)
		{
		...
		protected BookmarkEntityBase(System.Int32 threadID, System.Int32 userID, IValidator validator)
		{
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_user!=null)
			{
				_user.ActiveContext = this.ActiveContext;
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", BookmarkEntity.Relations.ThreadEntityUsingThreadID, true, signalRelatedEntity, "PresentInBookmarks", resetFKFields, new int[] { (int)BookmarkFieldIndex.ThreadID } );		
			_thread = null;
		}
		...
		private void SetupSyncThread(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", BookmarkEntity.Relations.ThreadEntityUsingThreadID, true, ref _alreadyFetchedThread, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", BookmarkEntity.Relations.UserEntityUsingUserID, true, signalRelatedEntity, "Bookmarks", resetFKFields, new int[] { (int)BookmarkFieldIndex.UserID } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntity relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", BookmarkEntity.Relations.UserEntityUsingUserID, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 threadID, System.Int32 userID, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)BookmarkFieldIndex.ThreadID].ForcedCurrentValueWrite(threadID);
				this.Fields[(int)BookmarkFieldIndex.UserID].ForcedCurrentValueWrite(userID);
		...
		{
			get	{ return new PrefetchPathElement(new SD.HnD.DAL.CollectionClasses.ThreadCollection(), (IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DAL.EntityType.BookmarkEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new SD.HnD.DAL.CollectionClasses.UserCollection(), (IEntityRelation)GetRelationsForField("User")[0], (int)SD.HnD.DAL.EntityType.BookmarkEntity, (int)SD.HnD.DAL.EntityType.UserEntity, 0, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
