...
namespace SD.HnD.DAL.EntityClasses
{
	...
	/// </summary>
	[Serializable]
	public  partial class AuditDataThreadRelatedEntityBase : AuditDataCoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public AuditDataThreadRelatedEntityBase()
		{
		...
		public AuditDataThreadRelatedEntityBase(System.Int32 auditDataID):base(auditDataID)
		{
		...
		public AuditDataThreadRelatedEntityBase(System.Int32 auditDataID, IPrefetchPath prefetchPathToUse):base(auditDataID, prefetchPathToUse)
		{
		...
		public AuditDataThreadRelatedEntityBase(System.Int32 auditDataID, IValidator validator):base(auditDataID, validator)
		{
		...
		{
			return AuditDataThreadRelatedEntity.GetRelationsForField(fieldName);
		}
		...
		public static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Thread":
					toReturn.Add(AuditDataThreadRelatedEntity.Relations.ThreadEntityUsingThreadID);
					break;
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("AuditDataThreadRelatedEntity", false);
		}
		...
		{
			AuditDataThreadRelatedDAO dao = new AuditDataThreadRelatedDAO();
			...
			return (AuditDataThreadRelatedEntity)dao.FetchExistingPolymorphic(transactionToUse, fields, contextToUse, excludedIncludedFields);
		}
		...
		public bool TestOriginalFieldValueForNull(AuditDataThreadRelatedFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AuditDataThreadRelatedFieldIndex fieldIndex)
		{
		...
		public virtual ThreadEntity GetSingleThread(bool forceFetch)
		{
			...
			{
				bool performLazyLoading = base.CheckIfLazyLoadingShouldOccur(AuditDataThreadRelatedEntity.Relations.ThreadEntityUsingThreadID);
		...
		{
			AuditDataThreadRelatedDAO dao = (AuditDataThreadRelatedDAO)CreateDAOInstance();
		...
		{
			base.PerformDesetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", AuditDataThreadRelatedEntity.Relations.ThreadEntityUsingThreadID, true, signalRelatedEntity, "AuditDataThreadRelated", resetFKFields, new int[] { (int)AuditDataThreadRelatedFieldIndex.ThreadID } );		
			_thread = null;
		}
		...
		private void SetupSyncThread(IEntity relatedEntity)
		{
			...
			{		
				...
				base.PerformSetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", AuditDataThreadRelatedEntity.Relations.ThreadEntityUsingThreadID, true, ref _alreadyFetchedThread, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement PrefetchPathThread
		{
			get
			{
				return new PrefetchPathElement(new SD.HnD.DAL.CollectionClasses.ThreadCollection(),
					(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DAL.EntityType.AuditDataThreadRelatedEntity, (int)SD.HnD.DAL.EntityType.ThreadEntity, 0, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return AuditDataThreadRelatedEntity.CustomProperties;}
		}
		...
		{
			get { return AuditDataThreadRelatedEntity.FieldsCustomProperties;}
		}

		/// <summary> The AuditDataID property of the Entity AuditDataThreadRelated<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "AuditDataThreadRelated"."AuditDataID"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int32 AuditDataID
		{
			get { return (System.Int32)GetValue((int)AuditDataThreadRelatedFieldIndex.AuditDataID, true); }
			set	{ SetValue((int)AuditDataThreadRelatedFieldIndex.AuditDataID, value, true); }
		}
		/// <summary> The ThreadID property of the Entity AuditDataThreadRelated<br/><br/>
		/// </summary>
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_thread != null)
						{
							_thread.UnsetRelatedEntity(this, "AuditDataThreadRelated");
						}
					}
					else
					{
						if(_thread!=value)
						{
							((IEntity)value).SetRelatedEntity(this, "AuditDataThreadRelated");
						}
					}
				}
			}
