...
namespace SD.HnD.DAL.DaoClasses
{
	...
	/// <summary>General DAO class for the Forum Entity. It will perform database oriented actions for a entity of type 'ForumEntity'.</summary>
	public partial class ForumDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public ForumDAO() : base(InheritanceHierarchyType.None, "ForumEntity", new ForumEntityFactory())
		{
		}
