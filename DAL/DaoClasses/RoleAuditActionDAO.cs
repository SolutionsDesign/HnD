...
namespace SD.HnD.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the RoleAuditAction Entity. It will perform database oriented actions for
	/// a entity of type 'RoleAuditActionEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class RoleAuditActionDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public RoleAuditActionDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "RoleAuditActionEntity", new RoleAuditActionEntityFactory())
		{
		}
		...
		internal RoleAuditActionDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves in the calling RoleAuditActionCollection object all RoleAuditActionEntity objects which have data in common
		...
		/// <summary>
		/// Retrieves entities of the type 'RoleAuditActionEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'RoleAuditAction' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
