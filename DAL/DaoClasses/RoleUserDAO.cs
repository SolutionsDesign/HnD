...
namespace SD.HnD.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the RoleUser Entity. It will perform database oriented actions for
	/// a entity of type 'RoleUserEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class RoleUserDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public RoleUserDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "RoleUserEntity", new RoleUserEntityFactory())
		{
		}
		...
		internal RoleUserDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves in the calling RoleUserCollection object all RoleUserEntity objects which have data in common
		...
		/// <summary>
		/// Retrieves entities of the type 'RoleUserEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'RoleUser' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
