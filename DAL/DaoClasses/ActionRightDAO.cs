...
namespace SD.HnD.DAL.DaoClasses
{
	...
	/// <summary>General DAO class for the ActionRight Entity. It will perform database oriented actions for a entity of type 'ActionRightEntity'.</summary>
	public partial class ActionRightDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public ActionRightDAO() : base(InheritanceHierarchyType.None, "ActionRightEntity", new ActionRightEntityFactory())
		{
		}
