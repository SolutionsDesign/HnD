...
namespace SD.HnD.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Message Entity. It will perform database oriented actions for
	/// a entity of type 'MessageEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class MessageDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public MessageDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "MessageEntity", new MessageEntityFactory())
		{
		}
		...
		internal MessageDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves in the calling MessageCollection object all MessageEntity objects which have data in common
		...
		/// <summary>
		/// Retrieves entities of the type 'MessageEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'Message' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
