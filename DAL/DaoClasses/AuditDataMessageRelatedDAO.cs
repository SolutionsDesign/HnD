...
namespace SD.HnD.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the AuditDataMessageRelated Entity. It will perform database oriented actions for
	/// a entity of type 'AuditDataMessageRelatedEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class AuditDataMessageRelatedDAO : AuditDataCoreDAO
	{
		/// <summary>CTor</summary>
		public AuditDataMessageRelatedDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.TargetPerEntity, "AuditDataMessageRelatedEntity", new AuditDataMessageRelatedEntityFactory())
		{
		}
		...
		internal AuditDataMessageRelatedDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves in the calling AuditDataMessageRelatedCollection object all AuditDataMessageRelatedEntity objects which have data in common
		...
		/// <summary>
		/// Retrieves entities of the type 'AuditDataMessageRelatedEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'AuditDataMessageRelated' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
