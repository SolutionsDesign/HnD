...
namespace SD.HnD.DAL.DaoClasses
{
	...
	/// <summary>General DAO class for the AuditDataThreadRelated Entity. It will perform database oriented actions for a entity of type 'AuditDataThreadRelatedEntity'.</summary>
	public partial class AuditDataThreadRelatedDAO : AuditDataCoreDAO
	{
		/// <summary>CTor</summary>
		public AuditDataThreadRelatedDAO() : base(InheritanceHierarchyType.TargetPerEntity, "AuditDataThreadRelatedEntity", new AuditDataThreadRelatedEntityFactory())
		{
		}



		/// <summary>Retrieves in the calling AuditDataThreadRelatedCollection object all AuditDataThreadRelatedEntity objects which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter. </summary>
