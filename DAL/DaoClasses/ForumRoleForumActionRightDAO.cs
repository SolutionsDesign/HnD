...
namespace SD.HnD.DAL.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the ForumRoleForumActionRight Entity. It will perform database oriented actions for
	/// a entity of type 'ForumRoleForumActionRightEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class ForumRoleForumActionRightDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public ForumRoleForumActionRightDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "ForumRoleForumActionRightEntity", new ForumRoleForumActionRightEntityFactory())
		{
		}
		...
		internal ForumRoleForumActionRightDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves in the calling ForumRoleForumActionRightCollection object all ForumRoleForumActionRightEntity objects which have data in common
		...
		/// <summary>
		/// Retrieves entities of the type 'ForumRoleForumActionRightEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Deletes from the persistent storage all 'ForumRoleForumActionRight' entities which have data in common
		/// with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		/// </summary>
		/// <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or null if not.</param>
