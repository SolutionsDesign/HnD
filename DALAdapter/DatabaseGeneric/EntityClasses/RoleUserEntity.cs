...
namespace SD.HnD.DALAdapter.EntityClasses
{
			...
			
	{
		...
		public RoleUserEntity():base("RoleUserEntity")
		{
		...
		public RoleUserEntity(IEntityFields2 fields):base("RoleUserEntity")
		{
		...
		public RoleUserEntity(IValidator validator):base("RoleUserEntity")
		{
		...
		public RoleUserEntity(System.Int32 roleID, System.Int32 userID):base("RoleUserEntity")
		{
			InitClassEmpty(null, null);
			this.RoleID = roleID;
			this.UserID = userID;
		...
		/// <param name="validator">The custom validator object for this RoleUserEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public RoleUserEntity(System.Int32 roleID, System.Int32 userID, IValidator validator):base("RoleUserEntity")
		{
			InitClassEmpty(validator, null);
			this.RoleID = roleID;
			this.UserID = userID;
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(RoleUserEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", SD.HnD.DALAdapter.RelationClasses.StaticRoleUserRelations.RoleEntityUsingRoleIDStatic, true, signalRelatedEntity, "RoleUser", resetFKFields, new int[] { (int)RoleUserFieldIndex.RoleID } );
			_role = null;
		}
		...
		private void SetupSyncRole(IEntityCore relatedEntity)
		{
			if(_role!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", SD.HnD.DALAdapter.RelationClasses.StaticRoleUserRelations.RoleEntityUsingRoleIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.HnD.DALAdapter.RelationClasses.StaticRoleUserRelations.UserEntityUsingUserIDStatic, true, signalRelatedEntity, "RoleUser", resetFKFields, new int[] { (int)RoleUserFieldIndex.UserID } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.HnD.DALAdapter.RelationClasses.StaticRoleUserRelations.UserEntityUsingUserIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))),	(IEntityRelation)GetRelationsForField("Role")[0], (int)SD.HnD.DALAdapter.EntityType.RoleUserEntity, (int)SD.HnD.DALAdapter.EntityType.RoleEntity, 0, null, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)SD.HnD.DALAdapter.EntityType.RoleUserEntity, (int)SD.HnD.DALAdapter.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)SD.HnD.DALAdapter.EntityType.RoleUserEntity; }
		}
