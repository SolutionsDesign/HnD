...
namespace SD.HnD.DALAdapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public SupportQueueEntity(IEntityFields2 fields):base("SupportQueueEntity")
		{
		...
		public SupportQueueEntity(IValidator validator):base("SupportQueueEntity")
		{
		...
		protected SupportQueueEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_defaultForForums = (EntityCollection<ForumEntity>)info.GetValue("_defaultForForums", typeof(EntityCollection<ForumEntity>));
				_supportQueueThreads = (EntityCollection<SupportQueueThreadEntity>)info.GetValue("_supportQueueThreads", typeof(EntityCollection<SupportQueueThreadEntity>));
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			...
			{
				case "DefaultForForums":
					this.DefaultForForums.Add((ForumEntity)relatedEntity);
					break;
				case "SupportQueueThreads":
					this.SupportQueueThreads.Add((SupportQueueThreadEntity)relatedEntity);
					break;
				default:
					break;
			}
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			...
			{
				case "DefaultForForums":
					this.PerformRelatedEntityRemoval(this.DefaultForForums, relatedEntity, signalRelatedEntityManyToOne);
					break;
				case "SupportQueueThreads":
					this.PerformRelatedEntityRemoval(this.SupportQueueThreads, relatedEntity, signalRelatedEntityManyToOne);
					break;
				default:
					break;
			}
		...
		protected override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.DefaultForForums);
			toReturn.Add(this.SupportQueueThreads);
			return toReturn;
		}
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_defaultForForums", ((_defaultForForums!=null) && (_defaultForForums.Count>0) && !this.MarkedForDeletion)?_defaultForForums:null);
				info.AddValue("_supportQueueThreads", ((_supportQueueThreads!=null) && (_supportQueueThreads.Count>0) && !this.MarkedForDeletion)?_supportQueueThreads:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoDefaultForForums()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ForumFields.DefaultSupportQueueID, null, ComparisonOperator.Equal, this.QueueID));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSupportQueueThreads()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SupportQueueThreadFields.QueueID, null, ComparisonOperator.Equal, this.QueueID));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SupportQueueEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._defaultForForums);
			collectionsQueue.Enqueue(this._supportQueueThreads);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._defaultForForums = (EntityCollection<ForumEntity>) collectionsQueue.Dequeue();
			this._supportQueueThreads = (EntityCollection<SupportQueueThreadEntity>) collectionsQueue.Dequeue();
		...
		{
			bool toReturn = false;
			toReturn |=(this._defaultForForums != null);
			toReturn |=(this._supportQueueThreads != null);
		...
		public static IPrefetchPathElement2 PrefetchPathDefaultForForums
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ForumEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ForumEntityFactory))), (IEntityRelation)GetRelationsForField("DefaultForForums")[0], (int)SD.HnD.DALAdapter.EntityType.SupportQueueEntity, (int)SD.HnD.DALAdapter.EntityType.ForumEntity, 0, null, null, null, null, "DefaultForForums", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSupportQueueThreads
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SupportQueueThreadEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SupportQueueThreadEntityFactory))), (IEntityRelation)GetRelationsForField("SupportQueueThreads")[0], (int)SD.HnD.DALAdapter.EntityType.SupportQueueEntity, (int)SD.HnD.DALAdapter.EntityType.SupportQueueThreadEntity, 0, null, null, null, null, "SupportQueueThreads", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public virtual EntityCollection<ForumEntity> DefaultForForums
		{
			get { return GetOrCreateEntityCollection<ForumEntity, ForumEntityFactory>("DefaultSupportQueue", true, false, ref _defaultForForums);	}
		}
		...
		public virtual EntityCollection<SupportQueueThreadEntity> SupportQueueThreads
		{
			get { return GetOrCreateEntityCollection<SupportQueueThreadEntity, SupportQueueThreadEntityFactory>("SupportQueue", true, false, ref _supportQueueThreads);	}
		}
		...
		{ 
			get { return (int)SD.HnD.DALAdapter.EntityType.SupportQueueEntity; }
		}
