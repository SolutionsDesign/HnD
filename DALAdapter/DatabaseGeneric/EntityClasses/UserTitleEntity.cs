...
namespace SD.HnD.DALAdapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public UserTitleEntity():base("UserTitleEntity")
		{
		...
		public UserTitleEntity(IEntityFields2 fields):base("UserTitleEntity")
		{
		...
		public UserTitleEntity(IValidator validator):base("UserTitleEntity")
		{
		...
		public UserTitleEntity(System.Int32 userTitleID):base("UserTitleEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this UserTitleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public UserTitleEntity(System.Int32 userTitleID, IValidator validator):base("UserTitleEntity")
		{
			InitClassEmpty(validator, null);
			this.UserTitleID = userTitleID;
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoUsers()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(UserFields.UserTitleID, null, ComparisonOperator.Equal, this.UserTitleID));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(UserTitleEntityFactory));
		}
#if !CF
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<UserEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))), (IEntityRelation)GetRelationsForField("Users")[0], (int)SD.HnD.DALAdapter.EntityType.UserTitleEntity, (int)SD.HnD.DALAdapter.EntityType.UserEntity, 0, null, null, null, null, "Users", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<UserEntity, UserEntityFactory>("UserTitle", true, false, ref _users);	}
		}
		...
		{ 
			get { return (int)SD.HnD.DALAdapter.EntityType.UserTitleEntity; }
		}
