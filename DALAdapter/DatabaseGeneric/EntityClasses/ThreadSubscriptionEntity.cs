...
namespace SD.HnD.DALAdapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public ThreadSubscriptionEntity():base("ThreadSubscriptionEntity")
		{
		...
		public ThreadSubscriptionEntity(IEntityFields2 fields):base("ThreadSubscriptionEntity")
		{
		...
		public ThreadSubscriptionEntity(IValidator validator):base("ThreadSubscriptionEntity")
		{
		...
		public ThreadSubscriptionEntity(System.Int32 userID, System.Int32 threadID):base("ThreadSubscriptionEntity")
		{
			InitClassEmpty(null, null);
			this.UserID = userID;
		...
		/// <param name="validator">The custom validator object for this ThreadSubscriptionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ThreadSubscriptionEntity(System.Int32 userID, System.Int32 threadID, IValidator validator):base("ThreadSubscriptionEntity")
		{
			InitClassEmpty(validator, null);
			this.UserID = userID;
			this.ThreadID = threadID;
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ThreadSubscriptionEntityFactory));
		}
		...
		private void SetupSyncThread(IEntityCore relatedEntity)
		{
			if(_thread!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", SD.HnD.DALAdapter.RelationClasses.StaticThreadSubscriptionRelations.ThreadEntityUsingThreadIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.HnD.DALAdapter.RelationClasses.StaticThreadSubscriptionRelations.UserEntityUsingUserIDStatic, true, signalRelatedEntity, "ThreadSubscription", resetFKFields, new int[] { (int)ThreadSubscriptionFieldIndex.UserID } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.HnD.DALAdapter.RelationClasses.StaticThreadSubscriptionRelations.UserEntityUsingUserIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))),	(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DALAdapter.EntityType.ThreadSubscriptionEntity, (int)SD.HnD.DALAdapter.EntityType.ThreadEntity, 0, null, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)SD.HnD.DALAdapter.EntityType.ThreadSubscriptionEntity, (int)SD.HnD.DALAdapter.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)SD.HnD.DALAdapter.EntityType.ThreadSubscriptionEntity; }
		}
