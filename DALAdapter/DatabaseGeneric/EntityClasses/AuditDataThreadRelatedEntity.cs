...
namespace SD.HnD.DALAdapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("AuditDataThreadRelatedEntity", ((SD.HnD.DALAdapter.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AuditDataThreadRelatedEntityFactory));
		}
#if !CF
		...
		private void SetupSyncThread(IEntityCore relatedEntity)
		{
			if(_thread!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", SD.HnD.DALAdapter.RelationClasses.StaticAuditDataThreadRelatedRelations.ThreadEntityUsingThreadIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))),	(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DALAdapter.EntityType.AuditDataThreadRelatedEntity, (int)SD.HnD.DALAdapter.EntityType.ThreadEntity, 0, null, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)SD.HnD.DALAdapter.EntityType.AuditDataThreadRelatedEntity; }
		}
