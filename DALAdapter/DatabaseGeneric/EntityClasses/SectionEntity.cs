...
namespace SD.HnD.DALAdapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public SectionEntity():base("SectionEntity")
		{
		...
		public SectionEntity(IEntityFields2 fields):base("SectionEntity")
		{
		...
		public SectionEntity(IValidator validator):base("SectionEntity")
		{
		...
		public SectionEntity(System.Int32 sectionID):base("SectionEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this SectionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SectionEntity(System.Int32 sectionID, IValidator validator):base("SectionEntity")
		{
			InitClassEmpty(validator, null);
			this.SectionID = sectionID;
		}
		...
		protected SectionEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_forums = (EntityCollection<ForumEntity>)info.GetValue("_forums", typeof(EntityCollection<ForumEntity>));
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			...
			{
				case "Forums":
					this.Forums.Add((ForumEntity)relatedEntity);
					break;
				default:
					break;
			}
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			...
			{
				case "Forums":
					this.PerformRelatedEntityRemoval(this.Forums, relatedEntity, signalRelatedEntityManyToOne);
					break;
				default:
					break;
			}
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_forums", ((_forums!=null) && (_forums.Count>0) && !this.MarkedForDeletion)?_forums:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoForums()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ForumFields.SectionID, null, ComparisonOperator.Equal, this.SectionID));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SectionEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._forums);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._forums = (EntityCollection<ForumEntity>) collectionsQueue.Dequeue();
		...
		public static IPrefetchPathElement2 PrefetchPathForums
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ForumEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ForumEntityFactory))), (IEntityRelation)GetRelationsForField("Forums")[0], (int)SD.HnD.DALAdapter.EntityType.SectionEntity, (int)SD.HnD.DALAdapter.EntityType.ForumEntity, 0, null, null, null, null, "Forums", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public virtual EntityCollection<ForumEntity> Forums
		{
			get { return GetOrCreateEntityCollection<ForumEntity, ForumEntityFactory>("Section", true, false, ref _forums);	}
		}
		...
		{ 
			get { return (int)SD.HnD.DALAdapter.EntityType.SectionEntity; }
		}
