...
namespace SD.HnD.DALAdapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public BookmarkEntity():base("BookmarkEntity")
		{
		...
		public BookmarkEntity(IEntityFields2 fields):base("BookmarkEntity")
		{
		...
		public BookmarkEntity(IValidator validator):base("BookmarkEntity")
		{
		...
		public BookmarkEntity(System.Int32 threadID, System.Int32 userID):base("BookmarkEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this BookmarkEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BookmarkEntity(System.Int32 threadID, System.Int32 userID, IValidator validator):base("BookmarkEntity")
		{
			InitClassEmpty(validator, null);
			this.ThreadID = threadID;
			this.UserID = userID;
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(BookmarkEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", SD.HnD.DALAdapter.RelationClasses.StaticBookmarkRelations.ThreadEntityUsingThreadIDStatic, true, signalRelatedEntity, "PresentInBookmarks", resetFKFields, new int[] { (int)BookmarkFieldIndex.ThreadID } );
			_thread = null;
		}
		...
		private void SetupSyncThread(IEntityCore relatedEntity)
		{
			if(_thread!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _thread, new PropertyChangedEventHandler( OnThreadPropertyChanged ), "Thread", SD.HnD.DALAdapter.RelationClasses.StaticBookmarkRelations.ThreadEntityUsingThreadIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.HnD.DALAdapter.RelationClasses.StaticBookmarkRelations.UserEntityUsingUserIDStatic, true, signalRelatedEntity, "Bookmarks", resetFKFields, new int[] { (int)BookmarkFieldIndex.UserID } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", SD.HnD.DALAdapter.RelationClasses.StaticBookmarkRelations.UserEntityUsingUserIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ThreadEntityFactory))),	(IEntityRelation)GetRelationsForField("Thread")[0], (int)SD.HnD.DALAdapter.EntityType.BookmarkEntity, (int)SD.HnD.DALAdapter.EntityType.ThreadEntity, 0, null, null, null, null, "Thread", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)SD.HnD.DALAdapter.EntityType.BookmarkEntity, (int)SD.HnD.DALAdapter.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual ThreadEntity Thread
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "PresentInBookmarks", "Thread", _thread, true); 
				}
			}
		}
		...
		public virtual UserEntity User
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "Bookmarks", "User", _user, true); 
				}
			}
		}
		...
		{ 
			get { return (int)SD.HnD.DALAdapter.EntityType.BookmarkEntity; }
		}
