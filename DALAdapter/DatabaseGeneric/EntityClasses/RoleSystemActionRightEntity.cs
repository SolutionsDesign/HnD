...
namespace SD.HnD.DALAdapter.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public RoleSystemActionRightEntity():base("RoleSystemActionRightEntity")
		{
		...
		public RoleSystemActionRightEntity(IEntityFields2 fields):base("RoleSystemActionRightEntity")
		{
		...
		public RoleSystemActionRightEntity(IValidator validator):base("RoleSystemActionRightEntity")
		{
		...
		public RoleSystemActionRightEntity(System.Int32 roleID, System.Int32 actionRightID):base("RoleSystemActionRightEntity")
		{
			InitClassEmpty(null, null);
			this.RoleID = roleID;
		...
		/// <param name="validator">The custom validator object for this RoleSystemActionRightEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public RoleSystemActionRightEntity(System.Int32 roleID, System.Int32 actionRightID, IValidator validator):base("RoleSystemActionRightEntity")
		{
			InitClassEmpty(validator, null);
			this.RoleID = roleID;
			this.ActionRightID = actionRightID;
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(RoleSystemActionRightEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _actionRight, new PropertyChangedEventHandler( OnActionRightPropertyChanged ), "ActionRight", SD.HnD.DALAdapter.RelationClasses.StaticRoleSystemActionRightRelations.ActionRightEntityUsingActionRightIDStatic, true, signalRelatedEntity, "RoleSystemActionRights", resetFKFields, new int[] { (int)RoleSystemActionRightFieldIndex.ActionRightID } );
			_actionRight = null;
		}
		...
		private void SetupSyncActionRight(IEntityCore relatedEntity)
		{
			if(_actionRight!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _actionRight, new PropertyChangedEventHandler( OnActionRightPropertyChanged ), "ActionRight", SD.HnD.DALAdapter.RelationClasses.StaticRoleSystemActionRightRelations.ActionRightEntityUsingActionRightIDStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncRole(IEntityCore relatedEntity)
		{
			if(_role!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _role, new PropertyChangedEventHandler( OnRolePropertyChanged ), "Role", SD.HnD.DALAdapter.RelationClasses.StaticRoleSystemActionRightRelations.RoleEntityUsingRoleIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ActionRightEntityFactory))),	(IEntityRelation)GetRelationsForField("ActionRight")[0], (int)SD.HnD.DALAdapter.EntityType.RoleSystemActionRightEntity, (int)SD.HnD.DALAdapter.EntityType.ActionRightEntity, 0, null, null, null, null, "ActionRight", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(RoleEntityFactory))),	(IEntityRelation)GetRelationsForField("Role")[0], (int)SD.HnD.DALAdapter.EntityType.RoleSystemActionRightEntity, (int)SD.HnD.DALAdapter.EntityType.RoleEntity, 0, null, null, null, null, "Role", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)SD.HnD.DALAdapter.EntityType.RoleSystemActionRightEntity; }
		}
